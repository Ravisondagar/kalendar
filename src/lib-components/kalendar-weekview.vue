...
export default {
    ...
    computed: {
        ...
        hourHeight() {
            return (
                (this.kalendar_options.hourlySelection ? 1 : 6) *
                this.kalendar_options.cell_height
            );
            //this.kalendar_options.cell_height * (60 / this.kalendar_options.split_value);
            // * this.kalendar_options.hour_parts;
        },
        passedTime() {
            let { day_starts_at, day_ends_at, now, cell_height } =
            ...
            let distance =
                ((time_obj - new Date(day_starts)) / 1000 / 60 / 10) *
                cell_height;
